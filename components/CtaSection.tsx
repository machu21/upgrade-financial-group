        ...
        <div className="p-10 md:p-16 rounded-3xl bg-accent/20 border border-primary/20 relative overflow-hidden text-center shadow-2xl"> 
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-medium leading-relaxed">
              Don't wait until it's too late. Get life insurance that works for you—if you have the traditional life insurance upgrade it to the new evolving living benefits.
            </p>
